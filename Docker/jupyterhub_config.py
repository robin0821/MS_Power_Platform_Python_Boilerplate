...
#c.LDAPAuthenticator.server_address = 'ldap://10.60.50.1'
#c.LDAPAuthenticator.bind_dn_template = 'each.com.au{username}'
#c.LDAPAuthenticator.lookup_dn = True
#c.LDAPAuthenticator.use_ssl = False
#c.LDAPAuthenticator.server_port = 636
#c.LDAPAuthenticator.user_search_base = 'OU=EACH Users,DC=each,DC=com,DC=au'
...
#c.NativeAuthenticator.recaptcha_key = "6LfEheYfAAAAAPmOgHVrVB3H3bi-2W4ywPD80yvj"
#c.NativeAuthenticator.recaptcha_secret = "6LfEheYfAAAAAPOfwJqKkrNk9rNdspx02PQQ7gnm"
...
#c.AzureAdOAuthenticator.tenant_id = 'abd12378-691b-4518-9e57-f732ab1923ad'

#c.AzureAdOAuthenticator.oauth_callback_url = 'https://PMB-DEV02.each.com.au/hub/oauth_callback'
#c.AzureAdOAuthenticator.client_id = 'ee0e5a0d-dfd6-470b-8177-552bf8d438a2'
#c.AzureAdOAuthenticator.client_secret = '7a1e32ba-3048-4b81-bf61-9f45d196deab'
...
#  Default: set()
#c.JupyterHub.admin_users = set('robinduadmin')
...
NOTEBOOK_SHARED_DIR = '/home/jovyan/work/shared'
HOST_HOME_PATH = "/home"
...
#  Default: set()
#c.Authenticator.admin_users = {'jupyteradmin', 'robinduadmin'}
